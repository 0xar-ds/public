...
import { NecordResponseHandler } from '../../interface/gateway-response-handler.interface.ts';

@Injectable()
export class InteractionPromptModalHandler implements NecordResponseHandler<GatewayResponseType.InteractionPromptModal> {
